                ...
                <div class="card my-5">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-4">
                            <img src="pic/<?= $NameOfProduct; ?>.jpg" alt="" class="img-fluid rounded-start">
                        </div>
                        <div class="col-12 col-sm-12 col-md-8">
                            <?php $productDetail = findProduct($NameOfProduct, $Tools); ?>
                            <div class="card-body">
                                <div class="card-title fs-4"><?php if($productDetail['name'] == "lash") { echo "eyelash curler"; } else { echo $productDetail['name']; }?></div>
                                <div class="card-text mb-1"><?= $productDetail['detail']; ?></div>
                                <div class="card-text fs-5 mb-3">Price : <?php $discount = discount($NameOfProduct, $productDetail['price']); echo $discount; ?> Baht</div>
                                <form action="overall.php" method="post">
                                    ...
                                    <input type="hidden" name="name" value="<?php if($productDetail['name'] == "lash") { echo "eyelash curler"; } else { echo $productDetail['name']; } ?>" >
                                    <div class="row mb-2">
